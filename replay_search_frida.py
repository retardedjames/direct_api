...
if not re.fullmatch(r"vm\d+", _ACCOUNT):
    sys.exit(
        "ERROR: set TIKTOK_ACCOUNT=vmN (matching the local replay_search_vmN.py).\n"
        "Each scraper VM has its own identity file generated by clone_finalize.sh."
    )
