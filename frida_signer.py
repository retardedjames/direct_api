...
frida-server runs on the Waydroid container (192.168.240.112:27042), exposed
to the host via `adb forward tcp:27042 tcp:27042`. ADB connects to Waydroid
at 192.168.240.112:5555. Launch pattern:
...
ADB_DEVICE = os.environ.get("ADB_DEVICE", "192.168.240.112:5555")
